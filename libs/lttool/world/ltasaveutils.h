...
void SaveFVecLTANamed(const char* name, CLTANodeBuilder& lb, LTVector&vec);
void SaveFVecLTA(CLTANodeBuilder& lb, LTVector&vec);
...
inline void SaveFVecLTA(CLTANodeBuilder& lb, LTVector &vec)
{
	lb.Push();
		lb.AddValue(vec.x); 
		lb.AddValue(vec.y); 
...
inline void SaveFVecLTANamed(char* name, CLTANodeBuilder& lb, LTVector&vec)
{
	lb.Push();
		lb.AddValue(name);
		SaveFVecLTA(lb, vec);
