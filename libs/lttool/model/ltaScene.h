...
class CLTAKeyFrame : public ILTAObject {
	...
	std::vector<CLTAKeyFrame::key_value> m_times ;
	
	void Append( const CLTAKeyFrame::key_value & kv ) ;
...
inline	void CLTAKeyFrame::Add( int time, int value  ) { m_times.push_back( CLTAKeyFrame::key_value( time, value ) ) ; } 
inline	void CLTAKeyFrame::Add( int time , std::string & value ) { m_times.push_back(CLTAKeyFrame::key_value( time, value ) ) ; }
...
inline	const std::string& CLTAKeyFrame::GetVal( int i ) const { return m_times[i].value ; } 
