...
struct LTRenderStruct
{
    ...
    // Functions implemented by the render driver.
        ...
        void* (*GetDevice)(); // Note: In spring the renderer will link directly with the engine.
        ...
        LTRESULT        (*UploadCurrentFrameToEffect)(LTEffectShader* pEffect, const char* szParam);
        LTRESULT        (*UploadPreviousFrameToEffect)(LTEffectShader* pEffect, const char* szParam);
